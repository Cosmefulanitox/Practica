...
public:
    void Cargar(){
cout<<"Ingrese codigo de avion"<<endl;
        cin>>codigoAvion;
cout<<"Ingrese nombre de avion"<<endl;
        cargarCadena(nombre,29);
cout<<"Ingrese marca de avion"<<endl;
...
cout<<"Ingrese cantidad de asientos"<<endl;
    ...
    void Mostrar(){
        ...
        cout<<"Nombre de acion: "<<nombre<<endl;
        cout<<"Marca de avion: "<<marca<<endl;
        cout<<"Tipo de avion: "<<tipo<<endl;
...
public:
    void Cargar(){
        cout<<"ingrese numero de pasaje"<<endl;
        cin>>numeroPasaje;
cout<<"ingrese numero de pasajero"<<endl;
        cin>>numeroPasajero;
cout<<"ingrese codigo de avion"<<endl;
        cin>>codigoAvion;
cout<<"ingrese codigo de vuelo"<<endl;
        cargarCadena(codigoVuelo,4);
...
cout<<"ingrese fecha de compra"<<endl;
    ...
    void Mostrar(){
        cout<<"Numero de pasaje: "<<numeroPasaje<<endl;
